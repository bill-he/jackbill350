// ======================================================================
// HelloWorld_Blinky02.v generated from TopDesign.cysch
// 04/01/2016 at 17:27
...
module ADC_SAR_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("b357d007-ef57-4ae4-8777-b0bfd4df0694/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b357d007-ef57-4ae4-8777-b0bfd4df0694/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("2a8e0417-c571-4f07-9adb-fefdcb60817b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("762776506.4836"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_234));
