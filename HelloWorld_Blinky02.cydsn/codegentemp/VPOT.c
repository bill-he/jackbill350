...
*
* \funcusage
*  \snippet VPOT_SUT.c usage_VPOT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VPOT_SUT.c usage_VPOT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VPOT_SUT.c usage_VPOT_Read  
*******************************************************************************/
...
* preferred VPOT_Read() API because the 
* VPOT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VPOT_SUT.c usage_VPOT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VPOT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VPOT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VPOT_0_INTR       (First pin in the list)
    *  - VPOT_1_INTR       (Second pin in the list)
    *  - ...
    *  - VPOT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VPOT_SUT.c usage_VPOT_SetInterruptMode
    *******************************************************************************/
    void VPOT_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VPOT_0_INTR) != 0u) 
		{ 
			 VPOT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VPOT_SUT.c usage_VPOT_ClearInterrupt
    *******************************************************************************/
