...
#if !(CY_PSOC5A &&\
	 P6_3__PORT == 15 && ((P6_3__MASK & 0xC0) != 0))
...
void    P6_3_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the P6_3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(P6_3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in P6_3_SetInterruptMode() function.
     *  @{
     */
        #define P6_3_INTR_NONE      (uint16)(0x0000u)
        #define P6_3_INTR_RISING    (uint16)(0x0001u)
        #define P6_3_INTR_FALLING   (uint16)(0x0002u)
        #define P6_3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define P6_3_INTR_MASK      (0x01u) 
#endif /* (P6_3__INTSTAT) */
...
/* SIO registers */
#if defined(P6_3__SIO_CFG)
    #define P6_3_SIO_HYST_EN        (* (reg8 *) P6_3__SIO_HYST_EN)
    #define P6_3_SIO_REG_HIFREQ     (* (reg8 *) P6_3__SIO_REG_HIFREQ)
    #define P6_3_SIO_CFG            (* (reg8 *) P6_3__SIO_CFG)
    #define P6_3_SIO_DIFF           (* (reg8 *) P6_3__SIO_DIFF)
#endif /* (P6_3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define P6_3_0_INTTYPE_REG 		(* (reg8 *) P6_3__0__INTTYPE)
#endif /* (P6_3__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_P6_3_H */
