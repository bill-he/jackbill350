...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 2432u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U0_BASE) },	/* TD 14 */
		...
		{ 512u, 0x13u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_U0_BASE) },	/* TD 18 */
		...
		{ 256u, 0x18u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 23 */
		...
		{ 8u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_DAC1_SW0) },	/* TD 30 */
		{ 8u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_DAC3_SW0) },	/* TD 31 */
		...
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE + 0x00000080u) },	/* TD 38 */
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 39 */
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE + 0x00000080u) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE + 0x00000080u) },	/* TD 41 */
		...
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 44 */
		{ 128u, 0x2Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE + 0x00000080u) },	/* TD 45 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_DAC1_VAL),	/* TD 30 */
		(const void *)(BS_DAC3_VAL),	/* TD 31 */
		...
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 39 */
		(const void *)(BS_UDB_1_4_HV_ROUTING_VAL),	/* TD 40 */
		(const void *)(BS_UDB_2_4_HV_ROUTING_VAL),	/* TD 41 */
		(const void *)(BS_DSISWITCH_1_1_VAL),	/* TD 42 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 43 */
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_DSI3_3_HV_ROUTING_VAL),	/* TD 45 */
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT5_AMUX, 0x0201u);
