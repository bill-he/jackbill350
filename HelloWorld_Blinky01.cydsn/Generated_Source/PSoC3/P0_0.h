...
*/
     ...
     */
        /* Drive Modes */
        #define P0_0_DM_ALG_HIZ         PIN_DM_ALG_HIZ   /**< \brief High Impedance Analog   */
        #define P0_0_DM_DIG_HIZ         PIN_DM_DIG_HIZ   /**< \brief High Impedance Digital  */
        #define P0_0_DM_RES_UP          PIN_DM_RES_UP    /**< \brief Resistive Pull Up       */
        #define P0_0_DM_RES_DWN         PIN_DM_RES_DWN   /**< \brief Resistive Pull Down     */
        #define P0_0_DM_OD_LO           PIN_DM_OD_LO     /**< \brief Open Drain, Drives Low  */
        #define P0_0_DM_OD_HI           PIN_DM_OD_HI     /**< \brief Open Drain, Drives High */
        #define P0_0_DM_STRONG          PIN_DM_STRONG    /**< \brief Strong Drive            */
        #define P0_0_DM_RES_UPDWN       PIN_DM_RES_UPDWN /**< \brief Resistive Pull Up/Down  */
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     *  @{
     */
        #define P0_0_INTR_NONE      (uint16)(0x0000u)   /**< \brief Disabled             */
        #define P0_0_INTR_RISING    (uint16)(0x0001u)   /**< \brief Rising edge trigger  */
        #define P0_0_INTR_FALLING   (uint16)(0x0002u)   /**< \brief Falling edge trigger */
        #define P0_0_INTR_BOTH      (uint16)(0x0003u)   /**< \brief Both edge trigger    */
        /** @} intrMode */
/** @} group_constants */
