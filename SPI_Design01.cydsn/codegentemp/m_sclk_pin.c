...
*
* \funcusage
*  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_Read  
*******************************************************************************/
...
* preferred m_sclk_pin_Read() API because the 
* m_sclk_pin_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: m_sclk_pin_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use m_sclk_pin_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - m_sclk_pin_0_INTR       (First pin in the list)
    *  - m_sclk_pin_1_INTR       (Second pin in the list)
    *  - ...
    *  - m_sclk_pin_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_SetInterruptMode
    *******************************************************************************/
    void m_sclk_pin_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & m_sclk_pin_0_INTR) != 0u) 
		{ 
			 m_sclk_pin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet m_sclk_pin_SUT.c usage_m_sclk_pin_ClearInterrupt
    *******************************************************************************/
