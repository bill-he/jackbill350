...
void    m_sclk_pin_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the m_sclk_pin_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(m_sclk_pin__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in m_sclk_pin_SetInterruptMode() function.
     *  @{
     */
        #define m_sclk_pin_INTR_NONE      (uint16)(0x0000u)
        #define m_sclk_pin_INTR_RISING    (uint16)(0x0001u)
        #define m_sclk_pin_INTR_FALLING   (uint16)(0x0002u)
        #define m_sclk_pin_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define m_sclk_pin_INTR_MASK      (0x01u) 
#endif /* (m_sclk_pin__INTSTAT) */
...
/* SIO registers */
#if defined(m_sclk_pin__SIO_CFG)
    #define m_sclk_pin_SIO_HYST_EN        (* (reg8 *) m_sclk_pin__SIO_HYST_EN)
    #define m_sclk_pin_SIO_REG_HIFREQ     (* (reg8 *) m_sclk_pin__SIO_REG_HIFREQ)
    #define m_sclk_pin_SIO_CFG            (* (reg8 *) m_sclk_pin__SIO_CFG)
    #define m_sclk_pin_SIO_DIFF           (* (reg8 *) m_sclk_pin__SIO_DIFF)
#endif /* (m_sclk_pin__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define m_sclk_pin_0_INTTYPE_REG 		(* (reg8 *) m_sclk_pin__0__INTTYPE)
#endif /* (m_sclk_pin__INTSTAT) */
