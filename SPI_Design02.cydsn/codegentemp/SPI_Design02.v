// ======================================================================
// SPI_Design02.v generated from TopDesign.cysch
// 04/24/2016 at 03:01
...
module top ;
	...
	wire [0:0] tmpOE__s_mosi_pin_net;
	wire [0:0] tmpIO_0__s_mosi_pin_net;
	wire [0:0] tmpINTERRUPT_0__s_mosi_pin_net;
	electrical [0:0] tmpSIOVREF__s_mosi_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("298d929f-889c-4aad-9dd7-82dbe8278575"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		s_mosi_pin
		 (.oe(tmpOE__s_mosi_pin_net),
		  .y({1'b0}),
		  .fb({Net_33}),
		  .io({tmpIO_0__s_mosi_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__s_mosi_pin_net),
		  .interrupt({tmpINTERRUPT_0__s_mosi_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__s_mosi_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__s_sclk_pin_net;
	wire [0:0] tmpIO_0__s_sclk_pin_net;
	wire [0:0] tmpINTERRUPT_0__s_sclk_pin_net;
	electrical [0:0] tmpSIOVREF__s_sclk_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("9a15eeaa-5e08-4489-9ab5-8e4f9e2981a1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		s_sclk_pin
		 (.oe(tmpOE__s_sclk_pin_net),
		  .y({1'b0}),
		  .fb({Net_35}),
		  .io({tmpIO_0__s_sclk_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__s_sclk_pin_net),
		  .interrupt({tmpINTERRUPT_0__s_sclk_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__s_sclk_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__s_ss_pin_net;
	wire [0:0] tmpIO_0__s_ss_pin_net;
	wire [0:0] tmpINTERRUPT_0__s_ss_pin_net;
	electrical [0:0] tmpSIOVREF__s_ss_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("aaf9d127-8d60-4228-ac15-db9299599c64"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		s_ss_pin
		 (.oe(tmpOE__s_ss_pin_net),
		  .y({1'b0}),
		  .fb({Net_109}),
		  .io({tmpIO_0__s_ss_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__s_ss_pin_net),
		  .interrupt({tmpINTERRUPT_0__s_ss_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__s_ss_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__s_miso_pin_net;
	wire [0:0] tmpFB_0__s_miso_pin_net;
	wire [0:0] tmpIO_0__s_miso_pin_net;
	wire [0:0] tmpINTERRUPT_0__s_miso_pin_net;
	electrical [0:0] tmpSIOVREF__s_miso_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("8e0cb82e-f575-4029-b36c-a93a71192a65"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		s_miso_pin
		 (.oe(tmpOE__s_miso_pin_net),
		  .y({Net_37}),
		  .fb({tmpFB_0__s_miso_pin_net[0:0]}),
		  .io({tmpIO_0__s_miso_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__s_miso_pin_net),
		  .interrupt({tmpINTERRUPT_0__s_miso_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__s_miso_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
